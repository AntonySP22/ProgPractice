...
const ExerciseSwiftCourse = () => {
  ...
  const handleCheck = () => {
    ...
    const correctEx1 = 'let nombre = "TuNombre"\nprint(nombre)';
    if (ex1 !== correctEx1) {
      setFeedback("Ejercicio 1: El código no es correcto. Revisa la sintaxis.");
      return;
    }
    ...
    if (
      exercise2op.trim() !== ">=" ||
      exercise2print.trim() !== '"Mayor de edad"'
    ) {
      setFeedback(
        'Ejercicio 2: Debes usar >= y el texto debe ser exactamente "Mayor de edad".'
      );
      return;
    }
      ...
      <div className={styles.mainContent}>
        <div className={styles.leftColumn}>
          ...
          <p className={styles.description}>
            Pon en práctica lo aprendido sobre Swift. ¡Comienza ahora y
            conviértete en un experto! 🚀
          </p>

          <div className={styles.exerciseItem}>
            <p className={styles.question}>
              1. Escribe un programa que almacene tu nombre en una constante y
